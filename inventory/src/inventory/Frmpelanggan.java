...
public class Frmpelanggan extends javax.swing.JDialog {
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmpelanggan.id,tmpelanggan.nama_petugas, tmpelanggan.kode, tmpelanggan.nama, tmpelanggan.no_telp, tmpelanggan.alamat FROM tmpelanggan");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmpelanggan.id,tmpelanggan.nama_petugas, tmpelanggan.kode, tmpelanggan.nama, tmpelanggan.no_telp, tmpelanggan.alamat FROM tmpelanggan WHERE tmpelanggan.id='"+row_id+"'");
                if(sql.next()){
            ...
            if("".equals(row_id)){
                if(c_kode == 0)
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO tmpelanggan(nama_petugas,kode, nama, no_telp, alamat) VALUES ('"+petugassession.getU_username()+"','" + row_txtkode + "', '" + row_txtnama + "', '" + row_txttelp + "', '" + row_txtalamat + "')");
                ...
                if(c_kode == 0 || row_txtkode.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmpelanggan SET nama_petugas='"+petugassession.getU_username()+"', kode='" + row_txtkode + "',nama='" + row_txtnama + "',no_telp='" + row_txttelp + "',alamat='" + row_txtalamat + "' WHERE id = '" + row_id + "'");
