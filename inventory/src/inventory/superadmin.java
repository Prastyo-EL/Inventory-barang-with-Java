...
public class superadmin extends javax.swing.JDialog {
    ...
    public superadmin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmsuperadmin.id, tmsuperadmin.nama, tmsuperadmin.username, tmsuperadmin.status, tmsuperadmin.hak_akses FROM tmsuperadmin");
    ...
    private void initComponents() {
        ...
        jLabel9.setLabelFor(txtusername);
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmsuperadmin.id, tmsuperadmin.nama, tmsuperadmin.username, tmsuperadmin.status, tmsuperadmin.hak_akses FROM tmsuperadmin WHERE tmsuperadmin.id='"+row_id+"'");
                if(sql.next()){
                    ...
                    akses.setText(sql.getString("hak_akses"));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        String row_txthak = akses.getText();
        ...
        else
        {
            ...
            if(!"".equals(row_txtnama) && !"".equals(row_txtusername) && !"".equals(row_txtpassword)){
                try {
                    Connection conn = konek.openkoneksi();
                    java.sql.Statement stm = conn.createStatement();
                    java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmsuperadmin.id) as count FROM tmsuperadmin WHERE tmsuperadmin.username='"+row_txtusername+"'");
                    sql.next();
                ...
                if("".equals(row_id)){
                    if(c_kode == 0)
                    {
                        try {
                            Connection conn = konek.openkoneksi();
                            java.sql.Statement stm = conn.createStatement();
                            stm.executeUpdate("INSERT INTO tmsuperadmin(nama, username, password, status, hak_akses) VALUES ('" + row_txtnama + "', '" + row_txtusername + "', '" + row_txtpassword + "', '" + row_txtstatus + "','"+row_txthak+"')");
                    ...
                    if(c_kode == 0 || row_txtusername.equals(row_txttemp_username))
                    {
                        try {
                            ...
                            stm.executeUpdate("UPDATE tmsuperadmin SET nama='" + row_txtnama + "',username='" + row_txtusername + "',password='" + row_txtpassword + "',status='" + row_txtstatus + "', hak_akses='"+row_txthak+"' WHERE id = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmsuperadmin WHERE id = '" + row_id + "'");
    ...
    private void aksesKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_aksesKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_aksesKeyTyped
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            superadmin dialog = new superadmin(new javax.swing.JFrame(), true);
